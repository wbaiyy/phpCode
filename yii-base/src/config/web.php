...
return [
    ...
    'components' => [
        ...
        'env' => [
            'class' => Wbaiyy\Base\Env::class,
            'env' => YII_ENV,
        ],
        'debug' => [
            'class' => Wbaiyy\Base\Debug::class,
            'isDebug' => YII_DEBUG,
        ],
        'datetime' => Wbaiyy\Base\Datetime::class,
        'assertion' => Wbaiyy\Base\Assertion::class,
        'ip' => Wbaiyy\Base\Ip::class,
        'arrayTree' => Wbaiyy\Base\ArrayTree::class,
    ],
    'params' => [
        'service' => [
            // 接口url
